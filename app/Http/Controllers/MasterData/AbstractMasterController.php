...
abstract class AbstractMasterController extends Controller {
 protected string $modelClass; protected string $menuCode; protected string $title; protected array $fields=[]; protected array $columns=['code'=>'Code','name'=>'Name'];
 ...
 protected function indexExtras(): array{return [];}
 ...
 public function show(int $id){return view('master.show',['record'=>$this->model($id),'title'=>$this->title,'fields'=>$this->fields,'options'=>$this->options(),'routeBase'=>$this->routeBase()]);}
 public function edit(int $id){return view('master.form',['record'=>$this->model($id),'title'=>$this->title,'fields'=>$this->fields,'options'=>$this->options(),'routeBase'=>$this->routeBase(),'isEdit'=>true]);}
