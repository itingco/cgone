...
final class PurchaseOrderDetailAdapter extends AbstractDatasourceAdapter
{
    public function code(): string { return 'PURCHASE_ORDER_DETAIL'; }
    public function name(): string { return 'Purchase Order Detail'; }
    ...
    {
        return [
            'document_no'=>$this->field('Purchase Order No','Document','string','h.document_no'),
